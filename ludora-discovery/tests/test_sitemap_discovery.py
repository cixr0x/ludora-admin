...
class SitemapDiscoveryTests(unittest.TestCase):
    def test_follows_wix_product_sitemap_with_product_page_paths(self):
        ...
        responses = {
            "https://geekystuff.example/sitemap.xml": FetchResult(
                url="https://geekystuff.example/sitemap.xml",
                text=f"""
                <sitemapindex>
            ...
            product_sitemap_url: FetchResult(
                ...
                text="""
                <urlset>
                  <url><loc>https://geekystuff.example/product-page/catan</loc></url>
                  <url><loc>https://geekystuff.example/product-page/</loc></url>
                </urlset>
                """,
            ),
        }
        ...
        self.assertEqual(urls, ["https://geekystuff.example/product-page/catan"])
